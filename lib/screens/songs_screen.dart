        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
                  ...
                  children: [
                    InkWell(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 20,
                          color: songController.isStorageSong.value
              ...
              Obx(
                () => songController.isStorageSong.value
                    ? Column(
                        // ignore: invalid_use_of_protected_member
                        children: songController.storageSongsList.value
                            .map(
                              (song) => SongListTile(
                                songName: song.title,
                                onTap: () {
                                  songPlayerController
                                      .playStorageSongs(song);
                                      songController.currentSongId(song.id);
                                  Get.to(
                                    PlaySongsScreen(
